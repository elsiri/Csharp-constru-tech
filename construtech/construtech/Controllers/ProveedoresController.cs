...
namespace construtech.Controllers
{
    ...
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(ConstruTechContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Proveedores != null ? 
                          ...
                          Problem("Entity set 'ConstruTechContext.Proveedores'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombres,Direccion,Estado,Email,Telefono,NombreContacto,TelefonoContacto,EmailContacto")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombres,Direccion,Estado,Email,Telefono,NombreContacto,TelefonoContacto,EmailContacto")] Proveedore proveedore)
        {
            if (id != proveedore.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ConstruTechContext.Proveedores'  is null.");
            }
            var proveedore = await _context.Proveedores.FindAsync(id);
            if (proveedore != null)
            {
