...
namespace construtech.Controllers
{
    ...
    public class EspecialidadesController : Controller
    {
        ...
        public EspecialidadesController(ConstruTechContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Especialidades != null ? 
                          ...
                          Problem("Entity set 'ConstruTechContext.Especialidades'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Especialidad,Estado")] Especialidade especialidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Especialidad,Estado")] Especialidade especialidade)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ConstruTechContext.Especialidades'  is null.");
            }
            var especialidade = await _context.Especialidades.FindAsync(id);
            if (especialidade != null)
            {
