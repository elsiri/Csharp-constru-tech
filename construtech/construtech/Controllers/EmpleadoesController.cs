...
namespace construtech.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public EmpleadoesController(ConstruTechContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Empleados != null ? 
                          ...
                          Problem("Entity set 'ConstruTechContext.Empleados'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Direccion,Estado,Email,Telefono,Cedula")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Direccion,Estado,Email,Telefono,Cedula")] Empleado empleado)
        {
            if (id != empleado.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ConstruTechContext.Empleados'  is null.");
            }
            var empleado = await _context.Empleados.FindAsync(id);
            if (empleado != null)
            {
