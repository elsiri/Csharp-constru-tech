...
namespace construtech.Controllers
{
    ...
    public class PermisoesController : Controller
    {
        ...
        public PermisoesController(ConstruTechContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Permisos != null ? 
                          ...
                          Problem("Entity set 'ConstruTechContext.Permisos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Permiso1,Estado")] Permiso permiso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Permiso1,Estado")] Permiso permiso)
        {
            if (id != permiso.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ConstruTechContext.Permisos'  is null.");
            }
            var permiso = await _context.Permisos.FindAsync(id);
            if (permiso != null)
            {
