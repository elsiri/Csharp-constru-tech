...
namespace construtech.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(ConstruTechContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Cedula,Clave,IdRol,IdEmpl")] Usuario usuario)
        {
            ...
            ViewData["IdEmpl"] = new SelectList(_context.Empleados, "Id", "Id", usuario.IdEmpl);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Cedula,Clave,IdRol,IdEmpl")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ConstruTechContext.Usuarios'  is null.");
            }
            var usuario = await _context.Usuarios.FindAsync(id);
            if (usuario != null)
            {
