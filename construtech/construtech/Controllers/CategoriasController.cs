...
namespace construtech.Controllers
{
    ...
    public class CategoriasController : Controller
    {
        ...
        public CategoriasController(ConstruTechContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categorias != null ? 
                          ...
                          Problem("Entity set 'ConstruTechContext.Categorias'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ConstruTechContext.Categorias'  is null.");
            }
            var categoria = await _context.Categorias.FindAsync(id);
            if (categoria != null)
            {
